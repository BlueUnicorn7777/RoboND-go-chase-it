...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pgm_map_creator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/RoboND-go-chase-it/catkin_ws/install/${idir}'.  Ask the maintainer 'robond <haoyang@udacity.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robond/RoboND-go-chase-it/catkin_ws/install/lib;/opt/ros/kinetic/lib)
